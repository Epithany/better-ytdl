...
export default function Home() {
    ...
    return (
        <div className="container mx-auto px-4 pb-16">
            ...
            {/* Primary Download UI */}
            <section className="flex justify-center md:mt-24">
            ...
            <section className="my-16">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 glass-panel p-5">
            ...
            {/* Steps Section */}
            <section className="my-20 glass-panel p-8 md:p-10">
                <h2 className="text-3xl lg:text-4xl font-bold text-center mb-12" id='how-it-works'>How it Works</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="text-center p-6 border border-white/60 bg-white/70 rounded-2xl shadow-sm">
            ...
            <section className="my-20 glass-panel p-8 md:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="p-6 border border-white/60 bg-white/70 rounded-2xl shadow-sm">
            ...
            <section className="my-20 text-center">
                ...
                <Link href="/download">
                    <button className="bg-black text-white py-3 px-8 text-lg font-medium rounded-2xl shadow-sm transition hover:bg-black/90">
                        Download Now
                    </button>
                </Link>
            </section>
